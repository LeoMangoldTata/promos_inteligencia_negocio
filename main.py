...
if os.getcwd() == 'C:\\Users\\leonardo.mangold\\PycharmProjects\\analisis\\kpis_promos_mauri':
...
for i in range(len(fechas)):
    ...
    cursor.execute(precios_oferta.format(id_promo = id, desde_snow = desde, hasta_snow = hasta))
